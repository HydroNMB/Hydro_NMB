...
This is wolfSSL version 5.8.0-preview1a, published as an Espressif Managed Component.
...
idf.py create-project-from-example "wolfssl/wolfssl^5.8.0-preview1a:wolfssl_benchmark"
